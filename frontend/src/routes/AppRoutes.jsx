  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="manufacturing" element={<ProtectedRoute allowedRoles={MFG_ROLES}><ManufacturingOrdersPage /></ProtectedRoute>} />
        <Route path="manufacturing/new" element={<ProtectedRoute allowedRoles={MFG_ROLES}><CreateManufacturingOrderPage /></ProtectedRoute>} />
        <Route path="manufacturing/:id" element={<ProtectedRoute allowedRoles={MFG_ROLES}><ManufacturingOrderDetailPage /></ProtectedRoute>} />
        <Route path="bom" element={<ProtectedRoute allowedRoles={MFG_ROLES}><BillOfMaterialsPage /></ProtectedRoute>} />
        <Route path="bom/:id" element={<ProtectedRoute allowedRoles={MFG_ROLES}><BomDetailPage /></ProtectedRoute>} />
        <Route path="work-centers" element={<ProtectedRoute allowedRoles={MFG_ROLES}><WorkCentersPage /></ProtectedRoute>} />
        <Route path="manufacturing-dashboard" element={<ProtectedRoute allowedRoles={MFG_ROLES}><ManufacturingDashboardPage /></ProtectedRoute>} />
